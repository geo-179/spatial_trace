...
class TraceProcessor:
    ...
    def analyze_trace(self, trace: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Analyze a reasoning trace and extract statistics.
                ...
                if isinstance(content, str) and content.strip():
                    try:
                        ...
                        if "action" not in parsed:
                            issues.append(f"Assistant message {i} missing 'action' field")
    ...
    def save_trace_with_analysis(
        ...
        """
        Save a trace with analysis metadata.
